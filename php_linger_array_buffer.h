...
#define PHP_LINGER_ARRAY_BUFFER_VERSION "0.1.0" /* Replace with version number for your extension */
...
ZEND_BEGIN_MODULE_GLOBALS(linger_array_buffer)
	long  global_value;
	char *global_string;
ZEND_END_MODULE_GLOBALS(linger_array_buffer)
*/

/* In every utility function you add that needs to use variables
   in php_linger_array_buffer_globals, call TSRMLS_FETCH(); after declaring other
   variables used by that function, or better yet, pass in TSRMLS_CC
   after the last function argument and declare your utility function
   with TSRMLS_DC after the last declared argument.  Always refer to
   the globals in your function as LINGER_ARRAY_BUFFER_G(variable).  You are
   encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/

#ifdef ZTS
#define LINGER_ARRAY_BUFFER_G(v) TSRMG(linger_array_buffer_globals_id, zend_linger_array_buffer_globals *, v)
#else
